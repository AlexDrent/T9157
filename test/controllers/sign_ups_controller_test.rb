...
class SignUpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sign_up" do
    assert_difference("SignUp.count") do
      post sign_ups_url, params: { sign_up: { first_name: @sign_up.first_name, last_name: @sign_up.last_name, paided: @sign_up.paided } }
    end
  ...
  test "should update sign_up" do
    patch sign_up_url(@sign_up), params: { sign_up: { first_name: @sign_up.first_name, last_name: @sign_up.last_name, paided: @sign_up.paided } }
