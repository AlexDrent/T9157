...
class AgendaItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda_item" do
    assert_difference("AgendaItem.count") do
      post agenda_items_url, params: { agenda_item: { details: @agenda_item.details, done: @agenda_item.done, subject: @agenda_item.subject } }
    end
  ...
  test "should update agenda_item" do
    patch agenda_item_url(@agenda_item), params: { agenda_item: { details: @agenda_item.details, done: @agenda_item.done, subject: @agenda_item.subject } }
